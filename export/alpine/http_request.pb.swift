...
extension CTXHTTP_HTTPRequest: @unchecked Sendable {}
...
extension CTXHTTP_HTTPRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularInt32Field(value: &self._tag) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: CTXHTTP_HTTPRequest, rhs: CTXHTTP_HTTPRequest) -> Bool {
